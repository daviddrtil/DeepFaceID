...
class ChallengeGenerator:
    def __init__(self, actions_count=6):
        ...
        list5 = [PoseAction.MOVE_HEAD_LEFT, PoseAction.MOVE_HEAD_UP, PoseAction.MOVE_HEAD_DOWN, OcclusionAction.COVER_NOSE, OcclusionAction.COVER_LEFT_EYE, OcclusionAction.COVER_MOUTH, ComplexAction({OcclusionAction.COVER_MOUTH, PoseAction.MOVE_HEAD_RIGHT})]
